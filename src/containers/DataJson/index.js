...
const DataJson = ({ flag }) => {
  ...
  const dataJsonLoading = useSelector((state) => state.dataJson.isLoading);
  const controversyJson = useSelector((state) => state.controversyJson.controversyJson);
  const controversyJsonLoading = useSelector((state) => state.controversyJson.isLoading);
    ...
    <div className="main">
      ...
      <div className="rightsidepane">
        ...
        <div className="container-main">
          ...
          <div>
            <CustomTable tableData={tableData} showDatePicker isLoading={dataJsonLoading || controversyJsonLoading} />
          </div>
        </div>
      </div>
    </div>
