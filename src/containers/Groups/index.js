    ...
    <Container>
      <Row>
        <Col lg={6} sm={12}>
          ...
          <div className="form-group group-input-width" ><input type="text" value={creategrpName} className={`form-control ${creategrpName === '' && inputValidate}`} maxLength={25} onChange={onhandelgrpName} autoComplete="off" required disabled={disablegrpName}></input></div>
        </Col>
        <Col lg={6} sm={12}>
